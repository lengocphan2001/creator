    ...
    <div class="p-2">
        <form class="form-horizontal" action="{{ route('creator.register') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="email" name="name" placeholder="Tên định danh">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="repassword" placeholder="{{ __('admin.placeholder.password') }}">
                @error('password')
                    <p class="text-danger mt-2">{{ $errors->first('password') }}</p>
                @enderror
            </div>
